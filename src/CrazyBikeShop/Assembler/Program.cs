...
builder.Services.AddDurableTaskWorker()
    ...
    .UseDurableTaskScheduler(Environment.GetEnvironmentVariable("ConnectionStrings__dts-assembler")!, options =>
    {
...
logger.LogInformation("Starting AssembleBikeActivity");
